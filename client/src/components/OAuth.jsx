...
export default function OAuth() {
  ...
  return (
    <button onClick={handleGoogleClick} type="button" aria-label="Sign in with Google" className="flex items-center justify-center bg-white border border-button-border-light rounded-lg p-0.5 pr-3">
