...
export default function SignUp() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto mb-48'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button disabled={loading} className='bg-slate-700 hover:bg-slate-800 disabled:opacity-80 text-white p-3 rounded-lg'>{loading ? 'Loading...' : 'Sign Up'}</button>
        <OAuth />
      </form>
